      ...
      <div className="container relative py-24 lg:py-36">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="#contact" className="inline-flex items-center justify-center px-8 py-3.5 bg-copper text-primary-foreground font-medium rounded hover:bg-copper-light transition-colors">
              {t("hero.cta")}
            </a>
            <a href="#services" className="inline-flex items-center justify-center px-8 py-3.5 border border-primary-foreground/20 text-primary-foreground font-medium rounded hover:bg-primary-foreground/5 transition-colors">
              {t("hero.services")}
            </a>
          </div>
        </div>
